...
- `new_chat` создает одну или несколько вкладок и возвращает номер чата или список номеров;
...
- `release_chat` освобождает один или несколько чатов и закрывает их вкладки.
